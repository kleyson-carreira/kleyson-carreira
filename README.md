...
const kleyson = {
  ...
  currentFocus: ["Ethical Hacking", "Cloud Architecture", "Automation"],
  motto: "Building secure, efficient, and innovative solutions"
};
```

Apaixonado por tecnologia desde os 14 anos, iniciei minha jornada em programação e empreendedorismo em 2013. Hoje, atuo como **Full Stack Developer** com foco crescente em **Cybersecurity** e **Ethical Hacking**. Acredito que a segurança deve ser parte fundamental de todo desenvolvimento de software.
